...
function getAccessToken()
{
    ...
    // With curl this should be: curl -X POST -d "grant_type=client_credentials" -H "Authorization: Basic base64encoding" "https://sso.dmz.dsmz.de/auth/"
